...
<head>
    ...
    <title>Blog - CODING WORLD - VISHAL SINGH</title>
...
<body>
    ...
    <div class="brand">DEVELOPER WORLD</div>
        ...
        <div class="row">
            <div class="box">
                ...
                <h2 class="text-center">Welcome <?php echo $fname; echo " "; echo $lname; ?> - <a href="logout.php">Logout</a></h2>
                    <hr>
                    <h2 class="intro-text text-center">Coding World
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
    ...
    <div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title">Coding world</h4>
		  </div>
...
<div id="myModal2" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			<h4 class="modal-title">Programming</h4>
		  </div>
		  <div class="modal-body">
			<p>Sample Text.</p>
		  </div>
